package com.bakirsoftware.survivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
		...
		public void render() {
			...
			if (gameState == 1) {
				...
				if (enemyX[scoredEnemy] < birdX - Gdx.graphics.getWidth() / 30) {
					score++;
				...
				for (int i = 0; i < numberOfEnemies; i++) {
					...
					enemyCircles[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30, Gdx.graphics.getHeight() / 2 + enemyOffSet[i] + Gdx.graphics.getHeight() / 20, Gdx.graphics.getWidth() / 35);
					enemyCircles2[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30, Gdx.graphics.getHeight() / 2 + enemyOffSet2[i] + Gdx.graphics.getHeight() / 20, Gdx.graphics.getWidth() / 35);
					enemyCircles3[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30, Gdx.graphics.getHeight() / 2 + enemyOffSet3[i] + Gdx.graphics.getHeight() / 20, Gdx.graphics.getWidth() / 35);
			...
			birdCircle.set(birdX + Gdx.graphics.getWidth() / 30, birdY + Gdx.graphics.getHeight() / 20, Gdx.graphics.getWidth() / 35);
